...
public class WithGenericFunctions {
	...
	*/
			            ...
			            public void edit(MethodCall m) throws CannotCompileException {
                            try {
                                ...
                                if(explain.hasAnnotation(GenericFunction.class)){
                                    ...
                                    String replace = "{$_=($r)new ist.meic.pa.GenericFunctions.Handler().handleMethodCall($args,\"" + it + "\",\"" + className + "\");}";
                                    m.replace(replace);
                                    explain.toClass();
                                }
	...
	public static void handleMethodCalls(CtClass explain, String className) throws CannotCompileException {
					...
					public void edit(MethodCall m) {
						...
						try {
							if (m.getMethod().getDeclaringClass().hasAnnotation(GenericFunction.class)) {
								//se o metodo da method call pertencer a uma classe anotada com GenericFunction, enviar a method call para o Handler
